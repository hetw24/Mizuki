...
let meting_api =
	...
	"https://api.sighproxy.dpdns.org/api?server=:server&type=:type&id=:id&auth=:auth&r=:r";
// Meting API 的 ID，从配置中获取或使用默认值
let meting_id = musicPlayerConfig.id ?? "17523884381";
...
const localPlaylist = [
	...
	},
	{
		...
		url: "assets/music/url/我生于死去之日.mp3",
		duration: 240,
	},
	{
		id: 3,
		...
		url: "assets/music/url/请不要带我走.mp3",
		duration: 180,
	},
	{
		id: 4,
		...
		url: "assets/music/url/未命名星系.mp3",
		duration: 180,
	},
	{
		id: 5,
